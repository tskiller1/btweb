               ...
               <table class="table table-bordered"  style="margin: 10px 10px 10px;max-width: 650px;">
                ...
                <tr>
                   <th>No3</th>
                    ...
                    <th><button type="button" class="btn btn-link" data-toggle="modal" data-target="#md1">Duyệt</button></th>
                </tr>
                <tr>
                  <th></th>
                  <th></th>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <h4>Xác nhận đồng ý với đơn này</h4>
                        <span style="margin-left: 100px; margin-top: 100px;">
                        <button class="button" data-dismiss="modal" >thoát</button>
                        <button class="button" data-dismiss="modal" >Không đồng ý</button>
                          <button class="button" data-dismiss="modal">Đồng ý</button>
