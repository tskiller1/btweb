  ...
  <body>
      ...
      <div class="crow">
        ...
        <div class ="crow">
          ...
          <div class=col-md-10>
            <div class=custom1>
              <p align="center"><font size="10">Gia hạn đề tài</font></p>
              <div class ="crow">
                <div class="col-md-3">
            </div>
            <div class=custom2>
            <form style="margin-left: 10px;">
                  ...
                  <div class="form-group">
                    <label for="pass">Gia hạn tới</label>
                    <input type="date" name="date" style="margin-left: 40px">
                  </div>    
                  <div class="form-group">
                    <label for="email">Lý do Gia hạn</label>
                    <textarea name="message" rows="10" cols="100" style="margin-left:30px"></textarea>
                  </div>
                  <input type="submit" value="Gửi" style="margin-left: 400px">
                </form>
              </div>
            </div>
          </div>
