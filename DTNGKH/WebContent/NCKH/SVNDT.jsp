  ...
  <body>
      ...
      <div class="crow">
        ...
        <div class ="crow">
          ...
          <div class=col-md-10>
            <div class=custom1>
              <p align="center"><font size="10">Nộp báo cáo đề tai</font></p>
              <div class ="crow">
                <div class="col-md-3">
            </div>
            <div class=custom2>
             <form style="margin-left: 10px;">
                  ...
                  <div class="form-group">
                   <label for="date">File upload</label>
                    <select id="quyen" name="quyen" style="margin-left: 40px">
                      <option value="Admin">Tên file</option>
                      <option value="sinhvien">Sinh Viên</option>
                  </div>  
                 <div class="form-group">
                 <input type="submit" value="Up file" style="margin-left: 20px">
                  </div>    
                  <div class="form-group">
                    <label for="email">Mô tả file</label>
